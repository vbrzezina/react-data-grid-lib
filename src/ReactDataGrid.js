(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "react", "./Grid", "./ToolbarContainer", "./common/editors/CheckboxEditor", "./formatters", "./RowUtils", "./ColumnUtils", "./KeyCodes", "./ColumnMetrics", "./common/enums", "./masks"], factory);
    }
    ...
    var CheckboxEditor_1 = require("./common/editors/CheckboxEditor");
    ...
    var ReactDataGrid = /** @class */ (function (_super) {
        ...
        function ReactDataGrid(props) {
            ...
            _this.handleCheckboxChange = function (e) {
                var allRowsSelected = e.currentTarget instanceof HTMLInputElement && e.currentTarget.checked;
                var rowSelection = _this.props.rowSelection;
        ...
        ReactDataGrid.prototype.componentWillReceiveProps = function (nextProps) {
            if (nextProps.columns) {
                if (!ColumnMetrics_1.sameColumns(this.props.columns, nextProps.columns, this.props.columnEquality)
        ...
        ReactDataGrid.prototype.setupGridColumns = function (props) {
            ...
            if (this.props.rowActionsCell || (props.enableRowSelect && !this.props.rowSelection) || (props.rowSelection && props.rowSelection.showCheckbox !== false)) {
                var SelectAllComponent = this.props.selectAllRenderer || formatters_1.SelectAll;
                var SelectAllRenderer = React.createElement(SelectAllComponent, { onChange: this.handleCheckboxChange, ref: this.selectAllCheckbox });
                var headerRenderer = props.enableRowSelect === 'single' ? undefined : SelectAllRenderer;
