(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "react", "classnames", "react-is", "./formatters", "./CellAction", "./CellExpander", "./ChildRowDeleteButton", "./ColumnUtils"], factory);
    }
    ...
    var CellAction_1 = require("./CellAction");
    var CellExpander_1 = require("./CellExpander");
    var ChildRowDeleteButton_1 = require("./ChildRowDeleteButton");
    ...
    var Cell = /** @class */ (function (_super) {
            ...
            if (cellMetaData.getCellActions) {
                ...
                if (cellActionButtons && cellActionButtons.length > 0) {
                    return cellActionButtons.map(function (action, index) {
                        return React.createElement(CellAction_1.default, tslib_1.__assign({ key: index, isFirst: index === 0 }, action));
                    });
                }
            }
            return null;
        ...
        Cell.prototype.renderCellContent = function () {
            ...
            else if (react_is_1.isValidElementType(Formatter)) {
                cellContent = React.createElement(Formatter, tslib_1.__assign({}, cellProps));
            }
            else {
                cellContent = React.createElement(formatters_1.SimpleCellFormatter, { value: value });
            }
        ...
        Cell.prototype.render = function () {
            ...
            var cellExpander = expandableOptions && expandableOptions.canExpand && (React.createElement(CellExpander_1.default, { expanded: expandableOptions.expanded, onCellExpand: this.handleCellExpand }));
