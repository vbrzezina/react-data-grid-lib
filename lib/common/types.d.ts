...
export declare type ColumnList = Column[] | List<Column>;
...
export declare type RowGetter = (rowIdx: number) => RowData;
...
export interface RowRenderer {
    ...
    getDecoratedComponentInstance?(idx: number): {
        row: RowRenderer & React.Component<RowRendererProps>;
    } | undefined;
}
...
export interface InteractionMasksMetaData {
    ...
    onGridRowsUpdated(cellKey: string, toRow1: number, toRow2: number, data: {
        [key: string]: unknown;
