...
export default class HeaderRow extends React.Component<HeaderRowProps> {
    ...
    getHeaderRenderer(column: CalculatedColumn): JSX.Element | React.ComponentClass<import("./common/types").HeaderRowProps<unknown, unknown>, any> | React.FunctionComponent<import("./common/types").HeaderRowProps<unknown, unknown>> | undefined;
