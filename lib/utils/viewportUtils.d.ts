...
export declare function getGridState(props: {
...
export declare function findLastFrozenColumnIndex(columns: CalculatedColumn[]): number;
export declare function getNonFrozenVisibleColStartIdx(columns: CalculatedColumn[], scrollLeft: number): number;
export declare function getNonFrozenRenderedColumnCount(columnMetrics: ColumnMetrics, viewportDomWidth: number, scrollLeft: number): number;
